...
<section style="padding: 120px 5% 60px; min-height: 70vh;">
   <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; flex-wrap: wrap; gap: 12px;">
      <div>
         <h1 style="margin: 0 0 4px 0;">Settings - Field Trip</h1>
   ...
   <div style="margin-bottom: 40px;">
      <h2 style="color: #d4b15a; margin-top: 0; margin-bottom: 16px; font-family: 'Cormorant Garamond', serif; font-size: 1.8rem; font-style: italic; border-bottom: 1px solid rgba(212,177,90,0.2); padding-bottom: 8px;">Daftar Wahana Field Trip</h2>
