      ...
      <table class="table table-sm text-white" style="width:100%; border-collapse: collapse;">
         <thead>
            <tr style="background: rgba(0,0,0,0.2);">
               ...
               <th style="text-align:center; padding:12px 10px; border-bottom:2px solid rgba(255,255,255,.15);">Tipe Media</th>
         ...
         <tbody id="galleryTableBody">
            ...
            <tr class="gallery-row-editable"
                ...
                data-type-media="{{ item['type_media'] }}"
               ...
               <td style="padding:12px 10px; border-bottom:1px solid rgba(255,255,255,.08); font-weight: 600; color: #d4b15a;">{{ item['title'] }}</td>
               ...
               <td style="padding:12px 10px; border-bottom:1px solid rgba(255,255,255,.08); text-align: center;"><span class="badge-category">{{ item['category'] }}</span></td>
               <td style="padding:12px 10px; border-bottom:1px solid rgba(255,255,255,.08); text-align: center;"><span class="badge-media">{{ item['type_media'] }}</span></td>
               <td style="padding:12px 10px; border-bottom:1px solid rgba(255,255,255,.08); text-align: center;">
                  {% if item['type_media'] == 'FOTO' %}
                     {% if item['resource_url'] %}
                        <img src="{{ url(item['resource_url']) }}" alt="{{ item['title'] }}" style="max-height:50px; max-width:80px; border-radius:6px; object-fit:cover; border:1px solid rgba(255,255,255,0.15);">
                     {% else %}
                        <em style="opacity:.5; font-size:0.9rem;">(tidak ada)</em>
                     {% endif %}
                  {% else %}
                     {% if item['resource_url'] %}
                        <a href="{{ url(item['resource_url']) }}" target="_blank" rel="noopener" style="color:#8fd3ff; text-decoration:none;">Lihat Video</a>
                     {% else %}
                        <em style="opacity:.5; font-size:0.9rem;">(tidak ada)</em>
                     {% endif %}
                  {% endif %}
...
<div id="editModal" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,.65); z-index:9999; align-items:center; justify-content:center; backdrop-filter: blur(4px);">
   <div style="width:min(640px, 92vw); background:#102417; color:#fff; border:1px solid rgba(255,255,255,.2); border-radius:16px; padding:24px; box-shadow: 0 10px 25px rgba(0,0,0,0.5);">
      <h3 style="margin:0 0 18px; font-size: 1.5rem; color:#d4b15a; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 10px;">Edit Galeri</h3>
      <form method="post" action="{{ url('settings/update_galeri') }}">
         ...
         <div style="margin-bottom:14px;">
            ...
            <input id="editTitle" name="title" type="text" required style="width:100%; padding:10px; border-radius:8px; border:1px solid rgba(255,255,255,.2); background:#203729; color:#fff;">
         </div>
         ...
         <div style="margin-bottom:14px; display: flex; gap: 12px; flex-wrap: wrap;">
            <div style="flex: 1; min-width: 150px;">
               ...
               <select id="editCategory" name="category" required style="width:100%; padding:10px; border-radius:8px; border:1px solid rgba(255,255,255,.2); background:#203729; color:#fff; cursor: pointer;">
            ...
            <div style="flex: 1; min-width: 150px;">
               ...
               <select id="editTypeMedia" name="type_media" required style="width:100%; padding:10px; border-radius:8px; border:1px solid rgba(255,255,255,.2); background:#203729; color:#fff; cursor: pointer;">
         ...
         <div id="editImageUploadContainer" style="margin-bottom:14px;">
            ...
            <input type="file" id="editImage" accept="image/*,video/mp4,video/webm,video/quicktime,video/x-m4v" style="width:100%; padding:8px; border-radius:8px; border:1px solid rgba(255,255,255,.2); background:#203729; color:#fff;">
...
<div id="addModal" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,.65); z-index:9999; align-items:center; justify-content:center; backdrop-filter: blur(4px);">
   <div style="width:min(640px, 92vw); background:#102417; color:#fff; border:1px solid rgba(255,255,255,.2); border-radius:16px; padding:24px; box-shadow: 0 10px 25px rgba(0,0,0,0.5);">
      <h3 style="margin:0 0 18px; font-size: 1.5rem; color:#d4b15a; border-bottom: 1px solid rgba(255,255,255,0.1); padding-bottom: 10px;">Tambah Galeri</h3>
      <form method="post" action="{{ url('settings/create_galeri') }}">
         ...
         <div style="margin-bottom:14px;">
            ...
            <input id="addTitle" name="title" type="text" required style="width:100%; padding:10px; border-radius:8px; border:1px solid rgba(255,255,255,.2); background:#203729; color:#fff;">
         </div>
         ...
         <div style="margin-bottom:14px; display: flex; gap: 12px; flex-wrap: wrap;">
            <div style="flex: 1; min-width: 150px;">
               ...
               <select id="addCategory" name="category" required style="width:100%; padding:10px; border-radius:8px; border:1px solid rgba(255,255,255,.2); background:#203729; color:#fff; cursor: pointer;">
            ...
            <div style="flex: 1; min-width: 150px;">
               ...
               <select id="addTypeMedia" name="type_media" required style="width:100%; padding:10px; border-radius:8px; border:1px solid rgba(255,255,255,.2); background:#203729; color:#fff; cursor: pointer;">
         ...
         <div id="addImageUploadContainer" style="margin-bottom:14px;">
            ...
            <input type="file" id="addImage" accept="image/*,video/mp4,video/webm,video/quicktime,video/x-m4v" style="width:100%; padding:8px; border-radius:8px; border:1px solid rgba(255,255,255,.2); background:#203729; color:#fff;">
         ...
         <div style="display:flex; gap:10px; justify-content:flex-end; border-top: 1px solid rgba(255,255,255,0.1); padding-top: 15px;">
            ...
            <button type="submit" style="padding:10px 18px; border-radius:8px; border:none; background:#d4b15a; color:#102417; font-weight:700; cursor: pointer;">Simpan Galeri</button>
         </div>
      </form>
   </div>
</div>
