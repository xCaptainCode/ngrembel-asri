...
<section style="padding: 120px 5% 60px; min-height: 70vh;">
   <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; flex-wrap: wrap; gap: 12px;">
      <div>
         <h1
            style="margin: 0 0 4px 0; font-family: 'Cormorant Garamond', serif; font-size: clamp(2rem, 5vw, 3rem); font-weight: 400;">Settings - Fun Games</h1>
         ...
         <form id="searchForm" method="GET"
            ...
            <input type="text" name="search" placeholder="Cari fun game..." value="{{ search }}"
            ...
            <a href="{{ url('settings/fun_game') }}" class="btn-reset">Reset</a>
            {% endif %}
         </form>
      </div>
      <div>
   ...
   <div style="margin-bottom: 40px;">
      ...
      <div style="display:flex; justify-content:center; align-items:center; margin-top:12px; gap:8px;">
         ...
         {% else %}
            <a href="{{ url('settings/fun_game') }}?{{ http_build_query({'search': search, 'page': prevPage, 'per_page': perPage}) }}"
         ...
         {% for i in 1..totalPages %}
            ...
            {% else %}
               <a href="{{ url('settings/fun_game') }}?{{ http_build_query({'search': search, 'page': i, 'per_page': perPage}) }}"
         ...
         {% else %}
            <a href="{{ url('settings/fun_game') }}?{{ http_build_query({'search': search, 'page': nextPage, 'per_page': perPage}) }}"
